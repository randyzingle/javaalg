...
class Display{
	...
	private Point[] mapper = { 
			...
			new Point(3, 7), // 8
			new Point(6, 5), // 9
			new Point(3, 9), // 10 Maps the game cell numbers to display array locations
	};
	...
	/** Move the fox indicator in the display
	 * @param fox the fox game piece immediately after a move. 
	 */
...
class MemoryManager{
	...
	public boolean smaller(int row, int current, int trial){
		return history[row][current] < history[row][trial];
	}

	public void summarize(int moves, int outcome) {
	...
	public void record(int moves, Fox fox, Police police){
...
public class FMG {
	...
	private String filename = "./src/fmg.memory";
	...
	public void oneGame() {
		...
		memory.summarize(moves - 1, outcome);
	}
